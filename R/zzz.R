...
.onAttach <- function(libname, pkgname){
  ...
  if(!reticulate::virtualenv_exists(envname = "r-reticulate-gotcha")){
    ...
    reticulate::virtualenv_create(envname = "r-reticulate-gotcha",
								  ...
								  python = "C:/Users/theo0/AppData/Local/Programs/Python/Python310/python.exe" ,
								  #python = "C:/Users/theo0/OneDrive/Documents/.virtualenvs/r-reticulate-gotcha/Scripts/python.exe",
                                  version = "python3",
